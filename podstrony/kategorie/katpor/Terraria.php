    ...
    <div class="container" style="align-items: center;">
      <div class="is section is-large">
        ...
        <div class="has-text-white is-size-4"><a href="/podstrony/kategorie/katpor/Terraria"></a>
          ...
          <img src="\obrazki\Terraria\dom.jpg" height="800rem" width="350rem">
          <img src="\obrazki\Terraria\domek.png" height="800rem" width="500rem">
          <p class="has-text-white is-size-4">Pamiętaj aby mieć zawsze wolny pokój, albo najlepiej kilka – przecież nigdy nie wiadomo, kiedy będzie się chciał wprowadzić nowy NPC. Jest to o tyle istotne że NPC są źródłem niektórych przedmiotów, których w żaden inny sposób nie można zdobyć.
Oprócz tego dobrze jest przeznaczyć jeden z pokoi na składzik – świetnie do tego celu nadają się porozrzucane po świecie skrzynie – można je przytargać do domu, po opróżnieniu ich z zawartości.</p><br>
        ...
        <img src="\obrazki\Terraria\swiat.png" height="800rem" width="850rem">
        ...
        <img src="\obrazki\Terraria\guide.png" height="800rem" width="850rem">
